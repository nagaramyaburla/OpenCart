...
public class ElementUtil {
	...
	public void doSelectByVisibleText(By locator, String visibleText) {
		...
		try {
			...
			Log.info("visble text is not present in the drop down");
			e.printStackTrace();
	...
	public String waitForTitleContains(String titleFraction, int timeOut) {
		...
		try {
			...
			Log.info("title is not found within : " + timeOut);
		}
		return null;
	...
	public String waitForURLContains(String urlFraction, int timeOut) {
		...
		try {
			...
			Log.info("url fraction is not found within : " + timeOut);
		}
		return driver.getCurrentUrl();
	...
	public String waitForURLIs(String url, int timeOut) {
		...
		try {
			...
			Log.info("url is not found within : " + timeOut);
		}
		return driver.getCurrentUrl();
	...
	public WebElement retryingElement(By locator, int timeOut) {
		...
		while (attempts < timeOut) {
			...
			try {
				...
				Log.info("element is found...." + locator + " in attempt " + attempts);
				break;
			} catch (NoSuchElementException e) {
				Log.info("element is not found.... " + " in attempts " + attempts);
		...
		if (element == null) {
			Log.info("element is not found.....tried for " + timeOut + " times " + " with the interval of "
					+ 500 + " milliseconds...");
